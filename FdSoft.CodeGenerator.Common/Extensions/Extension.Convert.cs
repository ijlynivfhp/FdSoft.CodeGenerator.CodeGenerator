...
namespace FdSoft.CodeGenerator.Common.Extensions
{
    public static partial class Extensions
    {
        ...
        #region DateTime Int,long转换
        /// <summary>
        /// DateTime 秒级别的Unix时间戳(int)
        /// </summary>
        /// <param name="dt"></param>
        /// <returns></returns>
        ...
        public static long DateTimeToLong(this DateTime dt)
        {
            System.DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new System.DateTime(1970, 1, 1, 0, 0, 0, 0));
            int dint = 10000;
            long t = (dt.Ticks - startTime.Ticks) / dint;
            return t;
        }

        /// <summary>
        /// 秒级别的Unix时间戳（int）转DateTime
        /// </summary>
        ...
        public static DateTime IntToDateTime(this int timeStamp)
        {
            ...
            var nowTick = ts * 10000000 + dtStart.Ticks;
            return new DateTime(nowTick);

        }
        /// <summary>
        /// 毫秒级别的Unix时间戳（long）转DateTime
        /// </summary>
        /// <param name="timeStamp"></param>
        /// <returns></returns>
        public static DateTime LongToDateTime(this long timeStamp)
        {
            DateTime dtStart = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1));
            if (timeStamp.ToString().Length > 10)
                return new DateTime(timeStamp * 10000 + dtStart.Ticks);
            else
                return new DateTime(timeStamp * 10000000 + dtStart.Ticks);
        }
        ...
        public static dynamic ToDyc(this object source)
        {
            ...
            var sourceStr = JsonConvert.SerializeObject(source);
            var sourceDyc = JsonConvert.DeserializeObject<dynamic>(sourceStr);
            return sourceDyc;
        }
        #endregion
    }
