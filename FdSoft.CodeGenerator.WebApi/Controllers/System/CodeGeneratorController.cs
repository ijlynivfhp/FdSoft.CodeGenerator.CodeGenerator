...
namespace FdSoft.CodeGenerator.WebApi.Controllers
{
    /// <summary>
    /// 代码生成
    /// </summary>
    ...
    public class CodeGeneratorController : BaseController
    {
        ...
        public IActionResult CodeGenerate([FromBody] GenerateDto dto)
        {
            ...
            //生成压缩包
            string zipReturnFileName = $"FdSoft.CodeGenerator.NET-{genTableInfo.TableComment}-{DateTime.Now:MMddHHmmss}.zip";
