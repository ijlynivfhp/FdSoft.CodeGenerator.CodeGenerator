...
namespace FdSoft.CodeGenerator.WebApi.Controllers.System
{
    /// <summary>
    /// 用户角色管理
    /// </summary>
    ...
    public class SysUserRoleController : BaseController
    {
        ...
        [Log(Title = "添加角色用户", BusinessType = Common.Enums.BusinessType.INSERT)]
        ...
        [Log(Title = "删除角色用户", BusinessType = Common.Enums.BusinessType.DELETE)]
