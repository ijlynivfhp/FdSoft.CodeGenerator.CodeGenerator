...
namespace FdSoft.CodeGenerator.WebApi.Extensions
{
    public static class SwaggerExtension
    {
        ...
        public static void UseSwagger(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c => c.SwaggerEndpoint("v1/swagger.json", "FdSoft.CodeGenerator v1"));
        }
        ...
        public static void AddSwaggerConfig(this IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "FdSoft.CodeGenerator.NET Api - .NET6",
                    Version = "v1",
                    Description = "",
                });
                try
                {
                    //添加文档注释
                    c.IncludeXmlComments("FdSoft.CodeGenerator.xml", true);
                }
                catch (Exception ex)
                {
